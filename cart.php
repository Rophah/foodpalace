...
<div class="col-md-2"></div>
	...
	<table class="table table-success mt-5 table-small">
		<thead>
			<tr>
				<th scope="col">#</th>
		...
		<?php 
		$order = $rec->orderDetails($price,$value['idfood'],$userid,$quantity,$total);
...
<div class="text-center">
	...
	<form action="paytrans.php" method="post">
		...
		<input type="hidden" name="foodprice" value="<?php echo $value['foodprice']?>">
		<input type="hidden" name="idfoodeach" value="<?php echo $value['idfood']; ?>">

		<?php 
		}?>
		<button type="submit" class="mr-5 mb-5" name="submit" onclick="deleteitem(<?php echo $userid; ?>)">Pay with PayStack</button>
	</form>
